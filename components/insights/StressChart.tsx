...
export function StressChart({ data }: { data: { date: string; score: number }[] }) {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-xl">Stress Trend</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="h-64 w-full mt-4">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={data}>
              ...
              />
              <Line type="monotone" dataKey="score" stroke="#FBBF24" strokeWidth={3} dot={{ r: 4, fill: "#FBBF24", strokeWidth: 0 }} activeDot={{ r: 6 }} />
            </LineChart>
          </ResponsiveContainer>
        </div>
      </CardContent>
